...
function Content() {
  return (
    ...
    //   </div>
    // </div>
     <section className="bg-white py-12 px-4 lg:px-40">
      {/* Title */}
      <h1 className="text-center text-2xl lg:text-3xl font-semibold mb-4">
        Literature Review Writing Service{" "}
        <span className="text-orange-500">At HIGS</span>
      </h1>

      {/* Intro Paragraph */}
      <p className="text-center text-gray-900 text-justify mb-8 leading-relaxed">
        Writing a literature review is an important part of your research journey. 
        Developing a convincing and critical research argument and discussions is the 
        toughest and most challenging task for a researcher. If you have no proper 
        experience and knowledge, then it is advised to hire some experts to do your 
        literature review writing work. So, HIGS comes with a number of literature 
        review writing experts, they will provide highly researched, quality filled, 
        plagiarism-free literature review for your research.
      </p>
...
>
  GET VIA WHATSAPP ↗
      ...
      {/* Subtitle */}
      <h2 className="text-center text-xl lg:text-2xl font-semibold mb-3">
        Customized Literature{" "}
        <span className="text-orange-500">Review Writing</span>
      </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
        <div>
          ...
          <p className="text-gray-700 text-sm leading-relaxed">
            ...
            you to decide the research topic, we group the articles into categories, and more.
          </p>
        </div>
        <div>
