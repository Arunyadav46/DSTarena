...
function Content2() {
    ...
    const data = [
        {img:"http://dstarena.com/wp-content/uploads/2015/06/image123.jpg",head:"PROJECTS",para:"We offer academic projects for ME/M.Tech, BE/B.Tech, BCA/MCA/MBA, and schools, covering major and minor projects for hands-on learning."},
        {img:"http://dstarena.com/wp-content/uploads/2015/05/image71.png",head:"Training & Learning",para:"We offer training in VLSI/VHDL, MATLAB, PHP/MySQL, Ethical Hacking, and SEO, providing hands-on learning for industry-ready skills."},
        {img:"http://dstarena.com/wp-content/uploads/2015/06/DSTvhdl1.png",head:"Corporate Services",para:"We provide Website Design & Development, Software Design, Data Migration, Article Writing, and Mail & SMS Services, ensuring seamless digital solutions for businesses."},
    ]
  return (
