...
function Content() {
  ...
  {/* Intro Paragraph */}
  <p className="text-justify text-[16px] leading-relaxed text-[#222] mb-10">
    HIGS is the leading review paper writing service in India, providing
    custom-made, error-free review papers. Unlock your successful review paper
    writing with our expert guidance & top-notch writing services. We are
    dedicated to offering the best research or article review paper writing
    with high quality and plagiarism-free within a given deadline.
    <br />
    <br />
    HIGS will clearly guide you on how to write a review paper and show you
    examples. We will be with you from the beginning to the end of your
    research work, ensuring better understanding and flawless delivery. Get
    step-by-step PhD review paper writing help from our team of experts.
  </p>

  {/* Qualities */}
  <h2 className="italic font-semibold text-xl text-center text-gray-800 mb-6">
    Our review paper writing comprises the following qualities:
  </h2>

  <div className="grid md:grid-cols-2 gap-6 mb-10">
    {[
      "It integrates findings, identifies patterns, and synthesizes information.",
      "It evaluates the strengths & weaknesses of existing research.",
      "Your review paper's introduction defines your topic.",
      "It highlights possible bias & limitations."
    ].map((quality, index) => (
  ...
  {/* Extra Paragraph */}
  <p className="text-center text- text-gray-900  mb-12">
    Our team at HIGS is not just a review paper writing company — we will be
    your all-around supporters from the beginning of your research to the end.
    We provide flawless review paper writing services across all research
    domains including Engineering, Arts, Science, Management, Marketing, and
    more.
  </p>

  {/* Steps Section */}
  <div className=" md:px-2 py-10 bg-white">
    <h2 className="text-3xl font-bold text-blue-800 mb-4">
      “7” Steps of Writing a Review Paper
    </h2>
    <p className="mb-10 text-[#222] leading-relaxed">
      At HIGS, we follow the 7 most crucial steps to write a review paper.
      At every step, we give priority to quality. Here’s a detailed
      overview of the steps we follow.
    </p>
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
      {steps.map((item, index) => (
        ...
        >
          ...
          <p className="mt-6 text-gray-700 leading-relaxed">{item.content}</p>
        </div>
      ))}
    </div>
  </div>
