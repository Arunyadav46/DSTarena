...
function Refer() {
    ...
    //   axios.get(`/API/dashboard/referral_payment_api.php?id=${userId}`)
    //   .then((res)=>{
...
//   formDataToSend.append("creadit_amount", formData.creadit_amount);
...
//         });
//       } else {
//         alert(data.response?.msg || "Withdrawal failed. Please try again.");
//       }
//     })
//     .catch((error) => {
//       alert("not widraw")
  ...
  {referralUsers.length > 0 ? (
    <div className="w-full min-w-[600px]">
      <table className="w-full table-fixed border-collapse text-left">
        <thead>
          <tr className="bg-gradient-to-r from-indigo-200/60 to-pink-200/60 text-gray-900 backdrop-blur-md shadow-sm">
            <th className="px-6 py-5 font-bold text-xs uppercase tracking-widest w-[5%] rounded-tl-2xl transition-all duration-300">
              #
            </th>
            <th className="px-6 py-5 font-bold text-xs uppercase tracking-widest w-[35%]">
              Name
            </th>
            <th className="px-6 py-5 font-bold text-xs uppercase tracking-widest w-[30%]">
              Join Referral ID
            </th>
            <th className="px-6 py-5 font-bold text-xs uppercase tracking-widest w-[30%] rounded-tr-2xl">
              Date
            </th>
          </tr>
        </thead>
      ...
      <div className="flex justify-end mt-6 pr-2">
        <button className="bg-green-600 hover:bg-green-700 text-white font-semibold px-6 py-2 rounded-md transition-all duration-300 shadow-md"
