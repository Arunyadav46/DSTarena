...
<div className='flex w-full bg-[#F8F8F8] min-h-screen'>
  ...
  <div className='lg:w-[77%] p-8 overflow-y-auto shadow-lg'>
    ...
    <div className='flex items-center mb-10 gap-5'>
      <img className='w-[5%]' src={img2} />
      <h2 className='text-3xl'>Projects</h2>
    </div>
    {/* <div className='mb-10'>
      <h2>Home <i class="ri-arrow-right-s-line"></i> <span>Projects</span></h2>
    </div> */}
            ...
            {BuyData.map((item, index) => (
              <tr key={index} className="border even:bg-gray-50 hover:bg-gray-100">
                ...
                <td className="p-4">
                  <div className="relative group inline-block">
                    {item.souce_code && (
                      <a href={item.souce_code} className="bg-blue-500 mr-3 text-white px-4 py-2 rounded-lg text-center hover:bg-blue-600 transition-all">
                        <i className="ri-download-line"></i>
                      </a>
                    )}
                    <div className="fixed w-[6%] z-50 left-[85%] -translate-x-1/2 mt-2 bg-gray-800 text-white text-sm px-3 py-1 rounded opacity-0 group-hover:opacity-100 transition-all pointer-events-none">
                  ...
                  {item.srs_report && (
                    <div className="relative group inline-block mr-3">
                      ...
                      <div className="fixed left-[90%] -translate-x-1/2 mt-2 bg-black text-white text-xs px-4 py-3 rounded opacity-0 group-hover:opacity-100 transition-all duration-300">
                        SRS Report
                      </div>
                    </div>
                  )}

                  <Link to="/dashboard/payment/det">
