...
import  img12 from "../assest2/application.webp"
import img13 from "../assest2/application.webp"
  ...
  return (
    ...
    <div className="container mx-auto text-center">
      ...
      <div className="bg-white shadow-lg rounded-lg p-6 flex flex-col items-center text-center transition-transform transform hover:scale-105">
            ...
            <p className="text-gray-600 mb-4">We provide the most responsive and functional backend development training for companies and developers worldwide.</p>
      ...
      <div className="bg-white shadow-lg rounded-lg p-6 flex flex-col items-center text-center transition-transform transform hover:scale-105">
            ...
            <p className="text-gray-600 mb-4">We provide the most responsive and functional programming training for companies and developers worldwide.</p>
            <div className="flex items-center space-x-2 text-blue-500">
              <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
              <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
      ...
      <div className="bg-white shadow-lg rounded-lg p-6 flex flex-col items-center text-center transition-transform transform hover:scale-105">
            ...
            <p className="text-gray-600 mb-4">We provide the most responsive and functional computational training for companies and researchers worldwide.</p>
            <div className="flex items-center space-x-2 text-blue-500">
              <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
              <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
      ...
      <div className="bg-white shadow-lg rounded-lg p-6 flex flex-col items-center text-center transition-transform transform hover:scale-105">
            ...
            <p className="text-gray-600 mb-4">We provide the most responsive and functional embedded solutions training for engineers and tech professionals worldwide.</p>
            <div className="flex items-center space-x-2 text-blue-500">
              <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
              <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
      ...
      <div className="bg-white shadow-lg rounded-lg p-6 flex flex-col items-center text-center transition-transform transform hover:scale-105">
            ...
            <p className="text-gray-600 mb-4">We provide the most responsive and creative web design training for businesses, freelancers, and aspiring designers worldwide.</p>
            <div className="flex items-center space-x-2 text-blue-500">
              <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
              <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
      ...
      <div className="bg-white shadow-lg rounded-lg p-6 flex flex-col items-center text-center transition-transform transform hover:scale-105">
            ...
            <p className="text-gray-600 mb-4">We provide the most responsive and practical backend development training using PHP & MySQL for developers and businesses worldwide.</p>
            <div className="flex items-center space-x-2 text-blue-500">
              <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
              <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
      ...
      <div className="bg-white shadow-lg rounded-lg p-6 flex flex-col items-center text-center transition-transform transform hover:scale-105">
            <img className="w-20 h-20 mb-4" src={cpu}/>
      ...
      <div className="bg-white shadow-lg rounded-lg p-6 flex flex-col items-center text-center transition-transform transform hover:scale-105">
            ...
            <p className="text-gray-600 mb-4">We provide the most responsive and functional digital solutions for companies and professionals worldwide.</p>
            <div className="flex items-center space-x-2 text-blue-500">
              <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
              <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
      ...
      <div className="bg-white shadow-lg rounded-lg p-6 flex flex-col items-center text-center transition-transform transform hover:scale-105">
            ...
            <p className="text-gray-600 mb-4">We provide the most responsive and result-driven SEO training for businesses, marketers, and professionals worldwide.</p>
            <div className="flex items-center space-x-2 text-blue-500">
              <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
              <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
